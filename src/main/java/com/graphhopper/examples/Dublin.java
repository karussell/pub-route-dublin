...
/**
 * Get PBF from http://download.bbbike.org/osm/bbbike/Dublin/
 *
 * @author Peter Karich
 */
public class Dublin {
    ...
    public static void main(String[] args) throws Exception {
        new Dublin().start(CmdArgs.read(args));
    }
    ...
    static class NoPubWeighting extends FastestWeighting {

        private final TIntHashSet avoidEdgeIds;

        public NoPubWeighting(TIntHashSet avoidEdgeIds, FlagEncoder encoder, PMap pMap) {
            super(encoder, pMap);
                    ...
                    protected GraphHopper createGraphHopper(CmdArgs args) {
                        ...
                        GraphHopper tmpHopper = new GraphHopper() {
                            ...
                            public Weighting createWeighting(WeightingMap weightingMap, FlagEncoder encoder) {
                                ...
                                if ("nopub".equalsIgnoreCase(weighting)) {
                                    return new NoPubWeighting(avoidEdgeIds, encoder, weightingMap);
                                }
                        ...
                        int objectCnt = 0;
                        try {
                            // grab geojson via http://overpass-turbo.eu/ and amenity=pub
                            String jsonStr = Helper.isToString(new FileInputStream(new File("./export.geojson")));
